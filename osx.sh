...
sudo scutil --set ComputerName "jeshua"
...
# Menu bar: set to transparent
defaults write NSGlobalDomain AppleEnableMenuBarTransparency -bool true

# Menu bar: show remaining battery time (on pre-10.8); hide percentage
defaults write com.apple.menuextra.battery ShowPercent -string "YES"
# defaults write com.apple.menuextra.battery ShowTime -string "YES" # doesn't work on mavericks?
...
# Finder: hide icons on desktop (while remaining accessible in finder)
...
# Set speed Mission Control animations
...
#  Animate hiding/showing the Dock
